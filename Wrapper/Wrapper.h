...
namespace Wrapper {
	...
	public:
		...
		void trackingError(cli::array<double, 2> ^ past, cli::array<double, 2> ^ pastConst, double t, double H, cli::array<double, 1>^ pricet, cli::array<double, 1>^ pocket, cli::array<double, 1>^ trackingE, cli::array<double, 1>^ V,int nbre,int nbConst);
